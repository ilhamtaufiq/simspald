<?php $__env->startSection('title', 'Tambah SPALD'); ?>
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="card card-absolute">
               ...
               <form action="<?php echo e(route('spald.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
               <div class="card-body">
                  <div class="mb-2">
...
unset($__errorArgs, $__bag); ?>
                 ...
                 <div class="mb-2">
                    ...
                    <div class="text-danger">
                      <?php $__errorArgs = ['id_rincian_kegiatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/halaman/ipald/input.blade.php ENDPATH**/ ?>