   ...
   <div class="main-header-right">
      ...
      <div class="nav-right col pull-right right-menu">
                                    ...
                                    <div class="col-xl-3 galleria-list clearfix lg-mt">
                                       ...
                                       <div>
                                          <div class="galleria row">
                                             <div class="col-6">
                                                <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/slider/1.jpg')); ?>" alt=""></a>
                                                <h4 class="username text-ellipsis">Airi Satou<small>Algerian</small></h4>
                                             </div>
                                             <div class="col-6">
                                                <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/slider/2.jpg')); ?>" alt=""></a>
                                                <h4 class="username text-ellipsis">Fiona Green<small>Korean</small></h4>
                                             </div>
                                             <div class="col-6 mb-0">
                                                <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/slider/3.jpg')); ?>" alt=""></a>
                                                <h4 class="username text-ellipsis mb-0">Gavin Joyce<small>Indian</small></h4>
                                             </div>
                                             <div class="col-6 mb-0">
                                                <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/slider/4.jpg')); ?>" alt=""></a>
         ...
         <ul class="nav-menus">
            ...
            <li class="onhover-dropdown">
               <img class="img-fluid img-shadow-warning" src="<?php echo e(asset('assets/images/dashboard/notification.png')); ?>" alt="">
...
</div><?php /**PATH /home/ekta/Documents/GitHub/poco_starter_kit/resources/views/layouts/megamenu/header.blade.php ENDPATH**/ ?>