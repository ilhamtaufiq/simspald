   ...
   <div class="row">
      <div class="col-sm-12">
         <div class="card">
            ...
            <form class="form theme-form" action="<?php echo e(route('rumah.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
               <div class="card-body">
                  <div class="row">
                     <div class="col">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/halaman/rumah/input.blade.php ENDPATH**/ ?>