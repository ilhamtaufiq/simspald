<?php $__env->startSection('title', 'Ringkasan Capaian'); ?>
          ...
          <div class="b-r-4 card-body">
            <div class="media static-top-widget">
              ...
              <div class="media-body"><span class="m-0">Total SPALD</span>
                <h4 class="mb-0"><?php echo e($spald); ?></h4><i class="icon-bg" data-feather="database"></i>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="b-r-4 card-body">
            <div class="media static-top-widget">
              ...
              <div class="media-body"><span class="m-0 text-white">Output (Rumah)</span>
                <h4 class="mb-0 text-white"><?php echo e(number_format($jiwa/5)); ?></h4><i class="icon-bg" data-feather="home"></i>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="b-r-4 card-body">
            <div class="media static-top-widget">
              ...
              <div class="media-body"><span class="m-0 text-white">Outcome (Jiwa)</span>
                <h4 class="mb-0 text-white"><?php echo e(number_format($jiwa)); ?></h4><i class="icon-bg" data-feather="user-plus"></i>
              </div>
            </div>
          </div>
        </div>
...
<script>
  var options1 = {
    ...
    series: [{
        name: 'Target (Jiwa)',
        data: [<?php echo e($j2020); ?>,<?php echo e($j2021); ?>,0],
    }, {
        name: 'Realisasi (Jiwa)',
        data: [<?php echo e($realisasi2020); ?>,<?php echo e($realisasi2021); ?>,0],
    }],
    xaxis: {
        type: 'text',
...
<script>
  var myLineChart = {
    ...
    datasets: [{
        label: "A",
        data: [<?php echo e($j2020); ?>,<?php echo e($j2021); ?>,0,0,0],
...
var doughnutData = [
    {
        value: <?php echo e($total_ipal); ?>,
        color: "#7e37d8",
        highlight: "#7e37d8",
        label: "IPAL Skala Permukiman"
    },
    {
        value: <?php echo e($total_ts); ?>,
        color: "#fe80b2",
        highlight: "#fe80b2",
        label: "Tangki Septik Individu"
    },
    {
        value: <?php echo e($total_ts_komunal); ?>,
        color: "#00c292",
        highlight: "#00c292",
        label: "Tangki Septik Komunal"
    },
    {
        value: <?php echo e($total_ipal_mck); ?>,
        color: "#03a9f3",
        highlight: "#03a9f3",
...
<script>
  var barData = {
    ...
    datasets: [{
        ...
        data: [<?php echo e($p2020); ?>, <?php echo e($p2021); ?>]
    }]
};
var barOptions = {
...
<?php echo $__env->make('layouts.sidebar_fixed.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/dashboard/index.blade.php ENDPATH**/ ?>