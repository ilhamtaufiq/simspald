...
<?php $__env->startSection('breadcrumb-title'); ?>
	<h2>Data Pengelola <span><?php echo e($title); ?>  </span></h2>
   <button onclick="location.href='<?php echo e(route('pengelola.create')); ?>'" class="btn btn-pill btn-primary btn-air-primary" type="submit" title="">Tambah</button>
...
<div class="container-fluid">
   <div class="row">
               ...
               <div class="dt-ext table-responsive">
                  <table class="display" id="export-button">
                     ...
                     <tbody>
                         ...
                         <tr>
                             <td><?php echo e($i++); ?></td>
                            <td><?php echo e($item->nama_ksm); ?></td>
                            
                            <td><?php echo e($item->ipald->rincian_kegiatan); ?> <?php echo e($item->ipald->n_desa); ?> <?php echo e($item->ipald->n_kec); ?></td>
                            <td><?php echo e($item->ipald->tahun_anggaran); ?></td>
                            <td>
                                 <a href="<?php echo e(route('pengelola.edit', $item->id)); ?>">
      ...
      <?php $__currentLoopData = $pengelola; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="modal fade" id="exampleModal<?php echo e($d->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                 ...
                 <div class="modal-body">Apakah Anda yakin akan menghapus data Pengelola <?php echo e($d->nama_ksm); ?>?</div>
                 <div class="modal-footer">
                    <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                    <form action="<?php echo e(route('pengelola.destroy', $d->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/halaman/pengelola/index.blade.php ENDPATH**/ ?>