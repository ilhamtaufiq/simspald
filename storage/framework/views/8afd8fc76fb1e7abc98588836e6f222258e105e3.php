...
<?php $__env->startSection('breadcrumb-title'); ?>
   ...
   <button onclick="location.href='<?php echo e(route('output.create')); ?>'" class="btn btn-pill btn-primary btn-air-primary" type="submit" title="">Tambah</button>
   <?php $__env->stopSection(); ?>
...
<div class="container-fluid">
   <div class="row">
                  ...
                  <table class="display" id="export-button">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><?php echo e($item->ipal); ?></td>
                           <td><?php echo e($item->sr); ?></td>
                           <td><?php echo e($item->tangki_septik); ?></td>
                           <td>
                                 <a href="<?php echo e(route('output.edit', $item->id)); ?>">
      ...
      <!-- Modal Hapus-->
      <?php $__currentLoopData = $output; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="modal fade" id="exampleModal<?php echo e($d->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                 ...
                 <div class="modal-body">Apakah Anda yakin akan menghapus data output <?php echo e($d->ipald->nama_ksm); ?>?</div>
                 <div class="modal-footer">
                    <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                    <form action="<?php echo e(route('output.destroy', $d->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/halaman/output/index.blade.php ENDPATH**/ ?>