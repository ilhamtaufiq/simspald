<?php $__env->startSection('title', 'Edit SPALD'); ?>
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="card">
               ...
               <form action="<?php echo e(route('spald.update', $spald->id_spald)); ?>" method="POST">
                <?php echo csrf_field(); ?>
               ...
               <div class="card-body">
                  <div class="mb-2">
                     ...
                     <select id="kec" name="id_kec" class="js-example-basic-single col-sm-12" placeholder="Kecamatan">
                        ...
                        <option value="<?php echo e($key); ?>" <?php echo e($key == $spald->id_kec ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                  ...
                  <div class="mb-2">
                    ...
                    <select value="" name="id_desa" id="id_desa" class="js-example-basic-single col-sm-12" >
                     <option value="<?php echo e($spald->id_desa); ?>" <?php echo e($spald->id_desa == $spald->id_desa ? 'selected' : ''); ?>><?php echo e($spald->desa->n_desa); ?></option>
                  </select>
                 </div>
                 <div class="mb-2">
                    ...
                    <select id="kegiatan" name="id_kegiatan" class="js-example-basic-single col-sm-12">
                        ...
                        <option value="<?php echo e($key); ?>" <?php echo e($key == $spald->id_kegiatan ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                 </div>
                 <div class="mb-2">
                    ...
                    <select value="" name="id_rincian_kegiatan" id="id_rincian_kegiatan" class="js-example-basic-single col-sm-12" >
                       <option value="<?php echo e($spald->id_rincian_kegiatan); ?>"><?php echo e($spald->rincianKegiatan->rincian_kegiatan); ?></option>
                    </select>
                 </div>
                 <div class="mb-2">
                    <div class="col-form-label">Sumber Dana</div>
                    <select name="sumber_dana" class="js-example-basic-single col-sm-12">
                       <option value="<?php echo e($spald->sumber_dana); ?>"><?php echo e($spald->sumber_dana); ?></option>
                 ...
                 <div class="mb-2">
                    ...
                    <input value="<?php echo e($spald->pagu); ?>" name="pagu" data-type="currency" id="currency-field" class="form-control" type="text">
                 </div>
                 <div class="mb-2">
                  <div class="col-form-label">Target Outcome</div>
                  <input value="<?php echo e($spald->jiwa); ?>" name="jiwa" class="form-control" type="number" placeholder="Satuan Jiwa">
                 </div>
                 <div id="spalds" class="mb-2">
                  <div class="col-form-label">Tangki Septik</div>
                  <input value="<?php echo e($spald->ts); ?>" name="ts" class="form-control" type="number" placeholder="Jumlah Target Tangki Septik Terbangun" >
                 </div>
                 <div id="spaldt">
                 <div class="mb-2">
                  <div class="col-form-label">IPAL</div>
                  <input value="<?php echo e($spald->ipal); ?>" disabled="" name="ipal" class="form-control" type="number" placeholder="Jumlah Target IPAL Terbangun">
                 </div>
                 <div class="mb-2">
                  <div class="col-form-label">Sambungan Rumah</div>
                  <input value="<?php echo e($spald->sr); ?>" name="sr" class="form-control" type="number" placeholder="Jumlah Target Sambungan Rumah Terbangun">
                 </div>
                 </div>
                 <div class="mb-2">
                    <div class="col-form-label">Tahun Anggaran</div>
                    <select name="tahun_anggaran" class="js-example-basic-single col-sm-12">
                        <option value="<?php echo e($spald->tahun_anggaran); ?>"><?php echo e($spald->tahun_anggaran); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/halaman/ipald/edit.blade.php ENDPATH**/ ?>