...
<script src="<?php echo e(asset('assets/js/jquery.drilldown.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/vertical-menu.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/megamenu.js')); ?>"></script>
<!-- Plugin used--><?php /**PATH /home/ekta/Documents/GitHub/poco_starter_kit/resources/views/layouts/megamenu/script.blade.php ENDPATH**/ ?>