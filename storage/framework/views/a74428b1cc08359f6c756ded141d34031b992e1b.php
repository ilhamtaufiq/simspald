      ...
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="card card-absolute">
               ...
               <form action="<?php echo e(route('pengelola.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
               <div class="card-body">
                  <div class="mb-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/halaman/pengelola/input.blade.php ENDPATH**/ ?>