...
<html lang="<?php echo e(app()->getLocale()); ?>">
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <?php else: ?>
                                <li><a class="nav-link" href="<?php echo e(route('users')); ?>"><?php echo trans('laravelusers::app.nav.users'); ?></a></li>
        ...
        <?php endif; ?>
        <?php echo $__env->make('laravelusers::scripts.toggleText', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php echo $__env->yieldContent('template_scripts'); ?>

    </body>
</html>
<?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/vendor/laravelusers/layouts/app.blade.php ENDPATH**/ ?>