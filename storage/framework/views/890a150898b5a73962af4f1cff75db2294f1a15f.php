...
<?php $__env->startSection('breadcrumb-title'); ?>
	<h2>Data <span><?php echo e($title); ?>  </span></h2> <br>
   <button onclick="location.href='<?php echo e(route('spald.create')); ?>'" class="btn btn-pill btn-primary btn-air-primary" type="submit" title="">Tambah</button>
   <?php $__env->stopSection(); ?>
...
<div class="container-fluid">
   <div class="row">
               ...
               <div class="dt-ext table-responsive">
                  <table class="display" id="export-button">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><?php echo e($i++); ?></td>
                           <td><?php echo e($item->rincianKegiatan->rincian_kegiatan); ?> <?php echo e($item->desa->n_desa); ?> <?php echo e($item->kec->n_kec); ?></td>
                           <td><?php echo e($item->pagu); ?></td>
                           <td><?php echo e($item->sumber_dana); ?></td>
                           <td><?php echo e($item->tahun_anggaran); ?></td>
                           <td>
                                 <a href="<?php echo e(route('spald.edit', $item->id_spald)); ?>">
                                 <button class="btn btn-primary" type="button">
                                    <i class="icon-settings"></i>         
                                 </button>
                                 </a>
                                 <button class="btn btn-primary" type="button" data-toggle="modal" data-original-title="test" data-target="#exampleModal<?php echo e($item->id_spald); ?>"><i class="icon-trash"></i></button>
                           </td>
                        </tr>
      ...
      <div class="modal fade" id="exampleModal<?php echo e($d->id_spald); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                 ...
                 <div class="modal-body">Apakah Anda yakin akan menghapus data <?php echo e($d->rincianKegiatan->rincian_kegiatan); ?> <?php echo e($d->desa->n_desa); ?> <?php echo e($d->kec->n_kec); ?>?</div>
                 <div class="modal-footer">
                    <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                    <form action="<?php echo e(route('spald.destroy', $d->id_spald)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/abs/resources/views/halaman/ipald/index.blade.php ENDPATH**/ ?>