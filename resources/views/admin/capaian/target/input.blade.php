...
@section('content')
<form action="/target/insert" method="POST">
  @csrf
<div class="col-md-12">
    <div class="card card-outline card-primary">
      <div class="card-header">
        <h3 class="card-title">Tambah Data Target Capaian</h3>
      </div>
        <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="div col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="number" name="total_rumah" class="form-control" placeholder="Total Rumah">
                    <div class="text-danger">
                        @error('total_rumah')
                            {{ $message }}
                        @enderror
