...
@section('breadcrumb-title')
   ...
   <button onclick="location.href='{{route('outcome.create')}}'" class="btn btn-pill btn-primary btn-air-primary" type="submit" title="">Tambah</button>
   @endsection
                  ...
                  <table class="display" id="export-button">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{$item->satuan}}</td>      
                           <td>
                              <a href="{{ route('outcome.edit', $item->id) }}">
      ...
      <div class="modal fade" id="exampleModal{{$d->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                 ...
                 <div class="modal-body">Apakah Anda yakin akan menghapus data outcome {{$d->ipald->nama_ksm}}?</div>
                 <div class="modal-footer">
                    <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                    <form action="{{ route('outcome.destroy', $d->id)}}" method="post">
                     @method('DELETE')
                     @csrf
