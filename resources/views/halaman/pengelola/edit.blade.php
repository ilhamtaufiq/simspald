               ...
               <div class="card-body">
                  <div class="mb-2">
                     ...
                     <select name="id_spald" class="js-example-basic-single col-sm-12" placeholder="">
                        <option value="{{$pengelola->id_spald}}">Pilih SPALD</option>
                        @foreach($spald as $s)
                    ...
                    <div class="mb-2">
                        ...
                        <input value="{{$pengelola->nama_ksm}}" type="text" name="nama_ksm" class="form-control" placeholder="Nama KSM">
                    </div>
                    <div class="mb-2">
                        <div class="col-form-label">
                            <input value="{{$pengelola->nama_ketua}}" type="text" name="nama_ketua" class="form-control" placeholder="Nama Ketua KSM">
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="col-form-label">
                            <input value="{{$pengelola->nik_ketua}}" type="text" name="nik_ketua" class="form-control" placeholder="NIK Ketua KSM">
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="col-form-label">
                            <input value="{{$pengelola->npwp}}" type="text" name="npwp" class="form-control" placeholder="NPWP KSM">
                        </div>
                    </div>
                 <br>
                 <div class="mb-2">
